...
export function RecordDetailDialog({
    ...
    <div className="space-y-4">
      ...
      {record.prompt && (
        <div>
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700/80 rounded-lg text-sm whitespace-pre-wrap leading-relaxed max-h-[50vh] overflow-y-auto">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[85vh] overflow-hidden top-[8vh] translate-y-0">
        <DialogHeader>
          <DialogTitle>
        ...
        <div className="grid grid-cols-[1fr_1fr] gap-6 overflow-y-auto max-h-[calc(85vh-100px)] pr-1">
          {/* Left Column: Images */}
          <div className="space-y-4">
            {renderImages()}
          </div>
