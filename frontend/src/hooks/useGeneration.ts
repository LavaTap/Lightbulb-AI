...
import type { APIConfig, VisionAnalysisResult, AnalysisCategory, ImageSize } from '@/types';
...
interface UseGenerationReturn {
  ...
  generate: (prompt: string, size?: ImageSize, config?: APIConfig) => Promise<string>;
  generateThreeView: (referenceImage: string, analysisPrompt: string, userPrompt?: string, config?: APIConfig) => Promise<string[]>;
  generatePoster: (images: string[], prompt: string, size?: ImageSize, config?: APIConfig) => Promise<string>;
  generateStoryboard: (characterImages: string[], sceneImage: string | undefined, prompt: string, config?: APIConfig, size?: ImageSize) => Promise<string>;
...
export function useGeneration(): UseGenerationReturn {
  ...
  const generatePoster = useCallback(async (images: string[], prompt: string, size?: ImageSize, overrideConfig?: APIConfig): Promise<string> => {
    setIsLoading(true);
    setError(null);
