import type { APIConfig, VisionAnalysisResult, ModelConfig, ModelCategory, Conversation, ChatMessage, MessageAttachment, ImageSize } from './index';
...
export interface GenerateImageRequest {
  ...
  config: APIConfig;
  size?: ImageSize;
  referenceImage?: string | string[];  // 可选参考图 base64，支持单张或多张
}
