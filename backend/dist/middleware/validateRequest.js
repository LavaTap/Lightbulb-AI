...
exports.createRecordSchema = exports.generatePosterSchema = exports.generateImageSchema = exports.analyzeSchema = exports.analysisCategorySchema = void 0;
...
exports.analyzeSchema = zod_1.z.object({
    ...
    config: zod_1.z.object({
        provider: zod_1.z.enum(['openai', 'google', 'deepseek', 'xfyun', 'custom']),
...
exports.createRecordSchema = zod_1.z.object({
    ...
    uploadImagesOriginal: zod_1.z.string().optional(),
    generatedImagesOriginal: zod_1.z.string().optional(),
